...
class ApiErrorCode {
  ...
  // ---------------------------------------------------------------------------
  static const legacyDeliveryFlowRetired = ApiErrorCode('legacy_delivery_flow_retired');
  static const legacyDzdQuoteRetired = ApiErrorCode('legacy_dzd_quote_retired');
  static const legacyMatchingFlowRetired = ApiErrorCode('legacy_matching_flow_retired');
  ...
  static const legacyTripSearchRetired = ApiErrorCode('legacy_trip_search_retired');
  static const legacyContractNotSupported = ApiErrorCode('legacy_contract_not_supported');
  ...
  static const parcelCancellationForbidden = ApiErrorCode('parcel_cancellation_forbidden');
  static const parcelCancellationFailed = ApiErrorCode('parcel_cancellation_failed');
  static const journeyNotActive = ApiErrorCode('journey_not_active');
  static const journeyNotOwned = ApiErrorCode('journey_not_owned');
  static const journeyProofUploadClosed = ApiErrorCode('journey_proof_upload_closed');
  static const proofOnlyForFlight = ApiErrorCode('proof_only_for_flight');
  static const flightProofNotApproved = ApiErrorCode('flight_proof_not_approved');
  ...
  static const routeProviderUnavailable = ApiErrorCode('route_provider_unavailable');
  static const routeProviderError = ApiErrorCode('route_provider_error');
  static const invalidReservationGrace = ApiErrorCode('invalid_reservation_grace');
  ...
  static const dealCancellationNotAvailable = ApiErrorCode('deal_cancellation_not_available');
  static const cancellationNotAvailableAfterPickup =
      ApiErrorCode('cancellation_not_available_after_pickup');
  ...
  static const deliveryCodeBufferOpen = ApiErrorCode('delivery_code_buffer_open');
  static const deliveryCodeNotArmed = ApiErrorCode('delivery_code_not_armed');
  static const pickupAlreadyConfirmed = ApiErrorCode('pickup_already_confirmed');
  static const pickupNotConfirmed = ApiErrorCode('pickup_not_confirmed');
  static const deliveryAlreadyConfirmed = ApiErrorCode('delivery_already_confirmed');
  ...
  static const providerNewCheckoutsDisabled = ApiErrorCode('provider_new_checkouts_disabled');
  static const clientSuppliedAmountRejected = ApiErrorCode('client_supplied_amount_rejected');
  ...
  static const dealBalanceOrderMissing = ApiErrorCode('deal_balance_order_missing');
  ...
  static const v1DealPaymentNotAvailable = ApiErrorCode('v1_deal_payment_not_available');
  ...
  static const disputeAlreadyResolved = ApiErrorCode('dispute_already_resolved');
  static const disputeAlreadyFinished = ApiErrorCode('dispute_already_finished');
  static const disputeReasonRequired = ApiErrorCode('dispute_reason_required');
  static const disputeCategoryInvalid = ApiErrorCode('dispute_category_invalid');
  static const disputeEvidenceLimitReached = ApiErrorCode('dispute_evidence_limit_reached');
  static const disputeEvidenceTooLarge = ApiErrorCode('dispute_evidence_too_large');
  static const disputeEvidenceTypeNotAllowed = ApiErrorCode('dispute_evidence_type_not_allowed');
  static const disputeEvidenceTypeMismatch = ApiErrorCode('dispute_evidence_type_mismatch');
  static const disputeEvidenceContentMismatch = ApiErrorCode('dispute_evidence_content_mismatch');
  static const disputeEvidenceFileRequired = ApiErrorCode('dispute_evidence_file_required');
  static const disputeEvidenceTextRequired = ApiErrorCode('dispute_evidence_text_required');
  static const disputeEvidenceKindInvalid = ApiErrorCode('dispute_evidence_kind_invalid');

  // ---------------------------------------------------------------------------
  // Ratings and boosts
  // ---------------------------------------------------------------------------
  static const ratingAlreadySubmitted = ApiErrorCode('rating_already_submitted');
  ...
  static const boostRequestNotEligible = ApiErrorCode('boost_request_not_eligible');

  // ---------------------------------------------------------------------------
  // Platform
  // ---------------------------------------------------------------------------
  static const businessSettingsUnavailable = ApiErrorCode('business_settings_unavailable');
  static const phase4PolicyUnavailable = ApiErrorCode('phase4_policy_unavailable');
